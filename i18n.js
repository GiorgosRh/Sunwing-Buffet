...
const I18N = {
  el: {
    ...
    "mod.recipes.desc":    "Υλικά & ποσότητες για 80 άτομα, βήματα προετοιμασίας, χρόνοι μαγειρέματος και αλλεργιογόνα.",
    ...
    // Recipes
    "recipes.subtitle":    "Buffet · 80 Άτομα · Sunwing Rhodes 2026",
  ...
  en: {
    ...
    "mod.recipes.desc":    "Ingredients & quantities for 80 people, preparation steps, cooking times and allergens.",
    ...
    // Recipes
    "recipes.subtitle":    "Buffet · 80 People · Sunwing Rhodes 2026",
